        ...
        <div className={`${geist.variable} ${gelasio.variable} font-sans`}>
            <div className="w-full h-full min-h-[90vh] flex flex-col items-center pt-20">
                <div className="max-w-3xl mx-auto w-full">
                    <div className=" text-7xl font-bold text-surface-800 dark:text-surface-0 text-center">
                        The Next-Gen
                        <br />
                    ...
                    <div className="mt-6 flex items-center justify-center gap-4">
                        <Link href={'/docs'} className="relative px-6 py-2.5 text-lg rounded-lg text-white font-medium overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-b from-blue-500 to-blue-600 transition-opacity" />
                            <div className="absolute inset-0 bg-gradient-to-b from-blue-500 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <span className="relative">Get Started</span>
                        </Link>
                        <Link
                            href={'https://github.com/primefaces/primereact'}
                            target="_blank"
                            className="px-6 py-2.5 flex items-center gap-2.5 text-lg rounded-lg border border-surface-300 dark:border-surface-700 hover:bg-surface-200 dark:hover:bg-surface-800 transition-all font-medium"
                        >
                            Give a Star
