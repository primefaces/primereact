...
<DocDemoViewer name="hooks:usemask:basic-demo" />
...
<DocDemoViewer name="hooks:usemask:format-patterns-demo" />
...
<DocDemoViewer name="hooks:usemask:optional-demo" />

### Slot Character

Default placeholder for a mask is underscore that can be customized using _slotChar_ option.

<DocDemoViewer name="hooks:usemask:slot-char-demo" />
