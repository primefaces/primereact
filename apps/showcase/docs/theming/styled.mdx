...
Nora is inspired by enterprise applications. Visit the [source code](https://github.com/primefaces/primereact/tree/master/packages/themes/src/presets)
...
<DocDemoViewer name="theming:colors-list" hideCode />
