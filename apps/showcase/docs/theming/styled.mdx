...
Nora is inspired by enterprise applications. Visit the [source code](https://github.com/primefaces/primevue/tree/master/packages/themes/src/presets)
...
<DocComponentViewer name="showcase:theming:colors-list" hideCode />
...
<DocComponentViewer name="showcase:styled:scoped-tokens-demo" />
...
<DocComponentViewer name="showcase:styled:css-modules-demo" />
