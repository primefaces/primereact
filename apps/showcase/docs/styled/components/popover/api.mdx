...
<DocTable name="PopoverRoot" category="api" type="props" />

### State

<DocTable name="PopoverRoot" category="api" type="state" />

### Exposes

<DocTable name="PopoverRoot" category="api" type="exposes" />

### Interfaces

<DocTable name="PopoverRoot" category="api" type="interfaces" />

### Types

<DocTable name="PopoverRoot" category="api" type="types" />
