...
<DocDemoViewer name="tabs:basic-demo" mode="collapsible"/>
...
<DocDemoViewer name="tabs:dynamic-demo" />

### Controlled

<DocDemoViewer name="tabs:controlled-demo" />

### Scrollable

<DocDemoViewer name="tabs:scrollable-demo" />

### Disabled

<DocDemoViewer name="tabs:disabled-demo" />

### Custom Indicator

<DocDemoViewer name="tabs:custom-indicator-demo" />

### Template

<DocDemoViewer name="tabs:template-demo" />
