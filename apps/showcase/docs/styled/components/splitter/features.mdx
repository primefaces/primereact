...
<DocDemoViewer name="splitter:basic-demo" mode="collapsible"/>
...
<DocDemoViewer name="splitter:horizontal-demo" />
...
<DocDemoViewer name="splitter:size-demo" />

## Vertical

Splitters can be combined to create advanced layouts.

<DocDemoViewer name="splitter:vertical-demo" />

## Nested

Splitters can be combined to create advanced layouts.

<DocDemoViewer name="splitter:nested-demo" />
