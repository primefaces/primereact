...
<DocDemoViewer name="stepper:basic-demo" mode="collapsible"/>
...
<DocDemoViewer name="stepper:linear-demo" />
...
<DocDemoViewer name="stepper:steps-only-demo" />
...
<DocDemoViewer name="stepper:template-demo" />
