...
<DocTable name="TimelineRoot" category="api" type="props" />

### Interfaces

<DocTable name="TimelineRoot" category="api" type="interfaces" />

### Types

<DocTable name="TimelineRoot" category="api" type="types" />
