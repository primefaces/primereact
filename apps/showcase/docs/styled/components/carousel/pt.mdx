...
<DocPTViewer name="carousel-pt" components={['CarouselRoot', 'CarouselContent', 'CarouselIndicator', 'CarouselIndicators', 'CarouselNext', 'CarouselPrev']} />

## CarouselRoot PT Options

<DocTable name="CarouselRoot" category="pt" />
