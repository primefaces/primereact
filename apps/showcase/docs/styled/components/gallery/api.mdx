...
<DocTable name="GalleryRoot" category="api" type="props" />

### Interfaces

<DocTable name="GalleryRoot" category="api" type="interfaces" />

### Types

<DocTable name="GalleryRoot" category="api" type="types" />
