...
<DocExampleViewer name="divider:content-demo" />

### Login

Sample implementation of a login form using a divider with content.

<DocExampleViewer name="divider:login-demo" />
