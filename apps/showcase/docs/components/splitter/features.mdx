...
<DocExampleViewer name="splitter:horizontal-demo" />
...
<DocExampleViewer name="splitter:size-demo" />

## Vertical

Splitters can be combined to create advanced layouts.

<DocExampleViewer name="splitter:vertical-demo" />

## Nested

Splitters can be combined to create advanced layouts.

<DocExampleViewer name="splitter:nested-demo" />
