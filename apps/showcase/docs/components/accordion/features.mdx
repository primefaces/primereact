...
<DocExampleViewer name="accordion:basic-demo" />
...
<DocExampleViewer name="accordion:multiple-demo" />
...
<DocExampleViewer name="accordion:custom-indicator-demo" />
...
<DocExampleViewer name="accordion:disabled-demo" />
...
<DocExampleViewer name="accordion:template-demo" />

### With RadioButton

`RadioButton` component can be used to group multiple `Accordion.Panel` components.

<DocExampleViewer name="accordion:use-with-radiobutton" />
