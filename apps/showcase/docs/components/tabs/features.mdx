...
<DocComponentViewer name="tabs:basic-demo" />

### Dynamic

<DocComponentViewer name="tabs:dynamic-demo" />

### Controlled

<DocComponentViewer name="tabs:controlled-demo" />

### Scrollable

<DocComponentViewer name="tabs:scrollable-demo" />

### Disabled

<DocComponentViewer name="tabs:disabled-demo" />

### Custom Indicator

<DocComponentViewer name="tabs:custom-indicator-demo" />

### Template

<DocComponentViewer name="tabs:template-demo" />
