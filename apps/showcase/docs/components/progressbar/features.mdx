...
<DocExampleViewer name="progressbar:basic-demo" />

### Dynamic

Value is reactive so updating it dynamically changes the bar as well.

<DocExampleViewer name="progressbar:dynamic-demo" />

### Formatter

Custom formatter function to format the display value.

<DocExampleViewer name="progressbar:formatter-demo" />
...
<DocExampleViewer name="progressbar:template-demo" />

### Indeterminate

For progresses with no value to track, set the `mode` property to `indeterminate`.

<DocExampleViewer name="progressbar:indeterminate-demo" />

### As Steps

Steps are used to display a progress with multiple steps.

<DocExampleViewer name="progressbar:steps-demo" />
