...
<DocExampleViewer name="metergroup:basic-demo" />
...
<DocExampleViewer name="metergroup:multiple-demo" />
...
<DocExampleViewer name="metergroup:color-demo" />

### Icon

Icons can be displayed next to the labels instead of the default `MeterGroup.Marker`.

<DocExampleViewer name="metergroup:icon-demo" />
...
<DocExampleViewer name="metergroup:label-demo" />
...
<DocExampleViewer name="metergroup:vertical-demo" />

### Min-Max

Boundaries are configured with the `min` and `max` values whose defaults are 0 and 100 respectively.

<DocExampleViewer name="metergroup:minmax-demo" />

### Template

MeterGroup provides templating support for labels, meter items, and content around the meters.

<DocExampleViewer name="metergroup:template-demo" />
