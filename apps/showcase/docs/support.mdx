        ...
        <div className="card !m-0 col-span-full lg:col-span-2">
            ...
            <ul className="flex flex-col gap-4 list-none m-0 p-0 text-lg">
                <li>
                    ...
                    <span className="leading-normal">Contact<a href="mailto:contact@primetek.com.tr" target="_blank" rel="noopener noreferrer" className="doc-link">PrimeTek</a> to purchase support. </span>
                </li>
                <li>
