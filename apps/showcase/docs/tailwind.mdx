...
The Tailwind v4 and PrimeReact [starter example](https://github.com/primefaces/primereact-examples/tree/main/vite-tailwindv4) is available to demonstrate the integration setup with an example dashboard.
