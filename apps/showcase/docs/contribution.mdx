...
Assist other users by participating in the issue tracker, <a href="https://github.com/orgs/primefaces/discussions/categories/primereact" target="_blank" rel="noopener noreferrer">GitHub discussions</a>, and the <a href="PrimeLand" target="_blank" rel="noopener noreferrer"> PrimeLand Discord </a> server. Your expertise can help others solve problems and improve their experience with PrimeReact.
...
Join the Contributors channel on the <a href="PrimeLand" target="_blank" rel="noopener noreferrer">PrimeLand Discord</a> server to connect with PrimeReact staff and fellow contributors. In this channel, you can discuss the areas you want to
