...
<DocTable name="CarouselRoot" category="api" type="props" />

### State

<DocTable name="CarouselRoot" category="api" type="state" />

### Exposes

<DocTable name="CarouselRoot" category="api" type="exposes" />

### Interfaces

<DocTable name="CarouselRoot" category="api" type="interfaces" />

### Types

<DocTable name="CarouselRoot" category="api" type="types" />
