---
title: CheckboxGroup Pass Through
description: Pass Through documentation for CheckboxGroup component
...
<DocPTViewer name="checkboxgroup-pt" components={['CheckboxGroup']} />
