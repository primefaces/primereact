...
Create a `prime-provider.tsx` file in the root of your project and add the following code:
...
Import the `PrimeProvider` in your root `layout.tsx` file and wrap your app with it.
