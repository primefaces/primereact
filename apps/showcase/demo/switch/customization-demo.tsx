...
export default function CustomizationDemo() {
    ...
    return (
        <div className="card flex justify-center items-center gap-2">
            <div className="flex items-center gap-2 bg-surface-50 hover:bg-surface-100 dark:bg-slate-700 hover:dark:bg-slate-800 p-4 rounded-md">
                ...
                <Switch checked={checked} onCheckedChange={(event: SwitchChangeEvent) => setChecked(event.checked)}>
