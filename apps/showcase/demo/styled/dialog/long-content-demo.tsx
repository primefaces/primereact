    ...
    return (
        <div className="flex justify-center">
            <Dialog.Root modal>
                ...
                <Dialog.Portal style={{ width: '40rem' }} className="max-h-[90vh]">
                    <FocusTrap>
                        <Dialog.Header>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed mt-0 mb-0 text-surface-600 dark:text-surface-300">
                                        ...
                                        materials on this service, even if we or an authorized representative has been notified orally or in writing
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed mt-0 mb-0 text-surface-600 dark:text-surface-300">
                                        ...
                                        information when you use our service. By using our service, you agree to the collection and use of information
                                        in accordance with our Privacy Policy. We are committed to ensuring that your information is secure and
                                        handled responsibly.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed mt-0 mb-0 text-surface-600 dark:text-surface-300">
                                        ...
                                        domestic and foreign countries. Our trademarks and trade dress may not be used in connection with any product
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed mt-0 mb-0 text-surface-600 dark:text-surface-300">
                                        ...
                                        fees, resulting from or arising out of your use and access of the service, or a breach of these Terms.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed mt-0 mb-0 text-surface-600 dark:text-surface-300">
                                        ...
                                        irrevocably submit to the exclusive jurisdiction of the courts in that location. Any claim relating to this
                                        service shall be governed by the laws without regard to its conflict of law provisions.
                                    </p>
                                </div>
