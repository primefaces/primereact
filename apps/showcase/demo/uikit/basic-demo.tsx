            ...
            <div className="card !mb-8" style={{ borderRadius: '50px' }}>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div className="w-full md:w-6/12">
                        ...
                        <p className="mb-4 text-lg">
                            Save countless hours on every project with a carefully designed system that uses Prime UI Suite components. Start
                            producing design results in no time.
                        </p>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    ...
                    <div className="w-full md:w-6/12">
                        ...
                        <p className="mb-4 text-lg">
                            PrimeOne is designed based on Aura Light and Aura Dark themes. Easily change the themes of your designs using Figma&apos;s
                            Swap Library feature or Tokens Studio Sets.
                        </p>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div className="w-full md:w-6/12">
                        ...
                        <p className="mb-4 text-lg">
                            Empower yourself with unprecedented control over your designs. Tokens Studio integration unlocks a whole new level of
                            flexibility, allowing you to create and manage design tokens seamlessly.
                        </p>
                    ...
                    <div className="w-full md:w-6/12">
                        <Image
                            ...
                            height={500}
                            alt="Tokens Support"
                            src="https://primefaces.org/cdn/primevue/images/uikit/uikit-tokens.png"
                            className="w-full"
                        />
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div className="w-full md:w-6/12">
                        <Image
                            ...
                            height={500}
                            alt="PrimeReact Designer"
                            src="https://primefaces.org/cdn/designer/feature-2.png"
                            className="w-full"
                        />
                    </div>
                    <div className="w-full md:w-6/12">
                        ...
                        <p className="mb-4 text-lg">
                            Bridge the gap between design and development with our powerful Figma sync technology. Fully integrated with the
                            PrimeReact Figma UI Kit, get started in no time by importing your design token file. Save countless hours in your workflow
                            by eliminating manual theme creation from Figma designs.
                        </p>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-6 mb-8">
                ...
                >
                    ...
                    <Image
                        ...
                        height={500}
                        alt="Figma Light"
                        src="https://primefaces.org/cdn/primevue/images/uikit/logo-figma-light.svg"
                        className="w-16"
                    />
                </a>
                <a
                ...
                >
                    ...
                    <Image
                        ...
                        height={500}
                        alt="Figma Dark"
                        src="https://primefaces.org/cdn/primevue/images/uikit/logo-figma-dark.svg"
                        className="w-16"
                    />
                </a>
            </div>
                        ...
                        <div className="p-4 h-full">
                            <div className="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style={{ borderRadius: '6px' }}>
                                ...
                                <a
                                    ...
                                    className="bg-blue-500 text-white hover:bg-blue-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple"
                                >
                                    Buy Now
                                </a>
                            </div>
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="p-4 h-full">
                            <div className="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style={{ borderRadius: '6px' }}>
                                ...
                                <a
                                    href="https://primeui.store/uikit"
                                    className="bg-purple-500 text-white hover:bg-purple-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple"
                                >
                                    Buy Now
                                </a>
                            </div>
                        ...
                        <div className="p-4 h-full">
                            <div className="shadow p-8 flex flex-col bg-surface-0 dark:bg-surface-900" style={{ borderRadius: '6px' }}>
                                ...
                                <a
                                    ...
                                    className="bg-gray-500 text-white hover:bg-gray-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple"
                                >
                                    Contact Us
                                </a>
                            </div>
            ...
            <div className="card" style={{ borderRadius: '50px' }}>
                ...
                <div className="grid grid-cols-12 gap-4 text-lg">
                    ...
                    <div className="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <p className="mt-0 mb-12 p-0 leading-normal">
                            All updates are completely free for the first year after your purchase. After this one-year period, you will no longer
                            have access to newer versions. However, all versions released within the first year from your purchase date will remain
                            accessible to you indefinitely.
                        </p>

                        <div className="leading-normal mb-2 font-bold">How Can I Extend My Access to Updates After One Year?</div>
                        <p className="mt-0 mb-12 p-0 leading-normal">
                            At PrimeStore, you have the option to purchase an additional update term. This will grant you access to all existing
                            versions and updates for another year.
                        </p>

                        <div className="leading-normal mb-2 font-bold">How can I get support?</div>
                        <p className="mt-0 mb-12 p-0 leading-normal">
                            PrimeTek offers assistance with account management and licensing issues, with the expectation that users have the
                            necessary technical knowledge to use our products, as we do not offer technical support or consulting. Users can seek
                            assistance in our community via our public{' '}
                    ...
                    <div className="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <div className="leading-normal mb-2 font-bold">
                        ...
                        <p className="mt-0 mb-12 p-0 leading-normal">
                            Due to the license, it is not possible to use the UI Kit in an open source project where the design files are publicly
                            available.
                        </p>
