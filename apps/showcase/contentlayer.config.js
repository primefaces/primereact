                ...
                visit(tree, (node) => {
                    if (node.name === 'DocExampleViewer') {
                        ...
                        if (name.includes(':')) {
                            ...
                            if (!Store.examples[component]?.[demo]) return null;

                            filePath = Store.examples[component][demo].filePath;
                        } else {
                            if (!Store.examples[name]) return null;

                            filePath = Store.examples[name].filePath;
                        }
                    ...
                    if (node.name === 'DocComponentViewer') {
                        ...
                        if (name.includes(':')) {
                            ...
                            if (!Store?.[dir]?.[component]?.[demo]) return null;

                            filePath = Store?.[dir]?.[component]?.[demo]?.filePath;
                        } else {
                            if (!Store?.[dir]?.[name]) return null;

                            filePath = Store?.[dir]?.[name]?.filePath;
                        }
