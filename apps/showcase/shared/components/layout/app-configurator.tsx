                ...
                <div className="flex flex-wrap gap-2">
                    {primaryColors.map((primaryColor) => (
                        <button
                            ...
                            className="size-5 rounded-full cursor-pointer outline-2 outline-offset-2 outline-transparent data-active:outline-primary-500/75 shadow-[0_0_0_1px_rgba(0,0,0,0.15)_inset,0_1px_0_1px_rgba(255,255,255,0.2)_inset,0_-1px_0_1px_rgba(0,0,0,0.2)_inset] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.025)_inset,0_1px_0_1px_rgba(255,255,255,0.2)_inset,0_-1px_0_1px_rgba(0,0,0,0.2)_inset]"
                            style={{ backgroundColor: `${primaryColor.name === 'noir' ? 'var(--text-color)' : primaryColor.palette?.['500']}` }}
                            {...(selectedPrimaryColor === primaryColor.name && { 'data-active': '' })}
                        ></button>
                    ))}
                </div>
            </div>
            <div>
                <div className="text-sm text-(--text-secondary-color) font-semibold text-balance mb-1.5">Surface</div>
                <div className="flex flex-wrap gap-2">
                    {surfaces.map((surface) => (
                        <button
                            ...
                            {...((selectedSurfaceColor ? selectedSurfaceColor === surface.name : app.isDarkTheme ? surface.name === 'zinc' : surface.name === 'slate') && { 'data-active': '' })}
                        ></button>
                    ))}
                </div>
            </div>
