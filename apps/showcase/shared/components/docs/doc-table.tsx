...
import { ApiChild, ApiData, ApiDataItem, NestedApiData } from '@/shared/types/Doc.types';
import { getApiDocs, getPTOptions, getStyleOptions, getTokenOptions } from '@/shared/utils/getComponentOptions';
