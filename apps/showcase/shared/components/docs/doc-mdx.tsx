import DocPTViewer from '@/shared/components/docs/doc-pt-viewer';
...
function DocMdx({ code, siteUrl }: { code: string; siteUrl: string }) {
    const Component = getMDXComponent(code, { siteUrl });
