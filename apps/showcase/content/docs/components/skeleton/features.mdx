...
<DocComponentViewer name="skeleton-shapes-demo" filePath="demo/skeleton/skeleton-shapes-demo.tsx"/>

## Card

Sample Card implementation using different Skeleton components and Tailwind CSS utilities.

<DocComponentViewer name="skeleton-card-demo" filePath="demo/skeleton/skeleton-card-demo.tsx"/>

## List

Sample List implementation using different Skeleton components and Tailwind CSS utilities.

<DocComponentViewer name="skeleton-list-demo" filePath="demo/skeleton/skeleton-list-demo.tsx"/>

## DataTable

Sample DataTable implementation using different Skeleton components and Tailwind CSS utilities.

<DocComponentViewer name="skeleton-datatable-demo" filePath="demo/skeleton/skeleton-datatable-demo.tsx"/>
