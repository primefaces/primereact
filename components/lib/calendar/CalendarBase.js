...
const classes = {
    ...
    year: ({ isYearSelected, y, checkDateIsDisabled }) => classNames('p-yearpicker-year', { 'p-highlight': isYearSelected(y), 'p-disabled': checkDateIsDisabled(-1, y) }),
    monthPicker: 'p-monthpicker',
    month: ({ isMonthSelected, checkDateIsDisabled, i, currentYear }) => classNames('p-monthpicker-month', { 'p-highlight': isMonthSelected(i), 'p-disabled': checkDateIsDisabled(i, currentYear) }),
