                    ...
                    <Link href="/">
                        <a className="layout-topbar-logo" aria-label="PrimeReact logo">
                            <svg width="146" height="35" viewBox="0 0 146 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                />
                                <mask id="mask0_2642_713" StyleClass="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="33" height="35">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.946167 0.0430908H32.1679V34.0431H0.946167V0.0430908Z" fill="white"/>
                                </mask>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.1761 20.5713L13.7323 18.2618L14.7049 18.8392H18.5955L19.5681 18.2618L21.1243 20.5713V29.2316L19.3056 32.6659H13.6397L12.1761 29.2316V20.5713Z" fill="var(--primary-color)"/>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2613 7.09967H14.1215L12.5652 10.7563L15.0941 18.0694H18.401L20.7353 10.7563L19.1791 7.09967H17.0394V18.0694H16.2613V7.09967Z" fill="var(--primary-color)"/>
                    ...
                    <Link href="/" aria-label="PrimeReact logo">
                        <a className="layout-topbar-icon">
                            <svg width="32" height="35" viewBox="0 0 32 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_2642_813" StyleClass="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="32" height="35">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.68338 0.0430908H31.9051V34.0431H0.68338V0.0430908Z" fill="white"/>
                                </mask>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9133 20.5713L13.4695 18.2618L14.4421 18.8392H18.3327L19.3053 18.2618L20.8615 20.5713V29.2316L19.0428 32.6659H13.3769L11.9133 29.2316V20.5713Z" fill="var(--primary-color)"/>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9985 7.09967H13.8586L12.3024 10.7563L14.8313 18.0694H18.1382L20.4725 10.7563L18.9163 7.09967H16.7766V18.0694H15.9985V7.09967Z" fill="var(--primary-color)"/>
