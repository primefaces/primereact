        ...
        <div ref={containerElement} className="layout-topbar">
            ...
            <ul ref={topbarMenu} className="topbar-menu p-unselectable-text" role="menubar">
                <li role="none" className="topbar-submenu">
                    ...
                    <CSSTransition nodeRef={themesOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={activeMenuIndex === 0} unmountOnExit>
                        <ul ref={themesOverlayRef} role="menu" aria-label="Themes">
                            ...
                            <li role="none">
                                <a href="https://www.primefaces.org/designer/primereact" role="menuitem">
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('bootstrap4-light-blue')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/bootstrap4-light-blue.svg`} alt="Blue Light" />
                                    <span>Blue Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('bootstrap4-light-purple')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/bootstrap4-light-purple.svg`} alt="Purple Light" />
                                    <span>Purple Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('bootstrap4-dark-blue', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/bootstrap4-dark-blue.svg`} alt="Blue Dark" />
                                    <span>Blue Dark</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('bootstrap4-dark-purple', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/bootstrap4-dark-purple.svg`} alt="Purple Dark" />
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('md-light-indigo')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-light-indigo.svg`} alt="Indigo Light" />
                                    <span>Indigo Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('md-light-deeppurple')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-light-deeppurple.svg`} alt="Deep Purple Light" />
                                    <span>Deep Purple Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('md-dark-indigo', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-dark-indigo.svg`} alt="Indigo Dark" />
                                    <span>Indigo Dark</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('md-dark-deeppurple', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-dark-deeppurple.svg`} alt="Deep Purple Dark" />
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('mdc-light-indigo')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-light-indigo.svg`} alt="Indigo Light" />
                                    <span>Indigo Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('mdc-light-deeppurple')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-light-deeppurple.svg`} alt="Deep Purple Light" />
                                    <span>Deep Purple Light</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('mdc-dark-indigo', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-dark-indigo.svg`} alt="Indigo Dark" />
                                    <span>Indigo Dark</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('mdc-dark-deeppurple', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/md-dark-deeppurple.svg`} alt="Deep Purple Dark" />
                                    <span>Deep Purple Dark</span>
                                </button>
                            </li>
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('tailwind-light')} role="menuitem">
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('fluent-light')} role="menuitem">
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-light-blue')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-light-blue.png`} alt="Lara Light Blue" />
                                    <span>Lara Blue</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-light-purple')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-light-purple.png`} alt="Lara Light Purple" />
                                    <span>Lara Purple</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-light-teal')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-light-teal.png`} alt="Lara Light Teal" />
                                    <span>Lara Teal</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-dark-indigo', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-dark-indigo.png`} alt="Lara Dark Indigo" />
                                    <span>Lara Indigo</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-dark-blue', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-dark-blue.png`} alt="Lara Dark Blue" />
                                    <span>Lara Blue</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-dark-purple', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/lara-dark-purple.png`} alt="Lara Dark Purple" />
                                    <span>Lara Purple</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('lara-dark-teal', true)} role="menuitem">
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('saga-green')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/saga-green.png`} alt="Saga Green" />
                                    <span>Saga Green</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('saga-orange')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/saga-orange.png`} alt="Saga Orange" />
                                    <span>Saga Orange</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('saga-purple')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/saga-purple.png`} alt="Saga Purple" />
                                    <span>Saga Purple</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('vela-blue', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/vela-blue.png`} alt="Vela Blue" />
                                    <span>Vela Blue</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('vela-green', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/vela-green.png`} alt="Vela Green" />
                                    <span>Vela Green</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('vela-orange', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/vela-orange.png`} alt="Vela Orange" />
                                    <span>Vela Orange</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('vela-purple', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/vela-purple.png`} alt="Vela Purple" />
                                    <span>Vela Purple</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('arya-blue', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/arya-blue.png`} alt="Arya Blue" />
                                    <span>Arya Blue</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('arya-green', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/arya-green.png`} alt="Arya Green" />
                                    <span>Arya Green</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('arya-orange', true)} role="menuitem">
                            ...
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('nova')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/nova.png`} alt="Nova" />
                                    <span>Nova</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('nova-alt')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/nova-alt.png`} alt="Nova Alt" />
                                    <span>Nova Alt</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('nova-accent')} role="menuitem">
                                    <img src={`${contextPath}/images/themes/nova-accent.png`} alt="Nova Accent" />
                                    <span>Nova Accent</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('luna-amber', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/luna-amber.png`} alt="Luna Amber" />
                                    <span>Luna Amber</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('luna-blue', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/luna-blue.png`} alt="Luna Blue" />
                                    <span>Luna Blue</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('luna-green', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/luna-green.png`} alt="Luna Green" />
                                    <span>Luna Green</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('luna-pink', true)} role="menuitem">
                                    <img src={`${contextPath}/images/themes/luna-pink.png`} alt="Luna Pink" />
                                    <span>Luna Pink</span>
                                </button>
                            </li>
                            <li role="none">
                                <button type="button" className="p-link" onClick={() => onThemeChange('rhea')} role="menuitem">
                ...
                <li role="none" className="topbar-submenu">
                    <button type="button" role="menuitem" onClick={() => toggleMenu(1)} aria-haspopup className="p-link">
                        Templates
                    </button>
                    <CSSTransition nodeRef={templatesOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={activeMenuIndex === 1} unmountOnExit>
                        <ul ref={templatesOverlayRef} role="menu" aria-label="Templates">
                            ...
                            <li role="none">
                                <a href="https://www.primefaces.org/sakai-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-sakai.svg`} alt="Sakai" />
                                    <span>Sakai</span>
                            ...
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/freya-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-freya.png`} alt="Freya" />
                                    <span>Freya</span>
                                </a>
                            </li>
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/diamond-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-diamond.png`} alt="Diamond" />
                                    <span>Diamond</span>
                                </a>
                            </li>
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/ultima-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-ultima.png`} alt="Ultima (Material)" />
                                    <span>Ultima</span>
                            ...
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/roma-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-roma.jpg`} alt="Roma" />
                                    <span>Roma</span>
                                </a>
                            </li>
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/sapphire-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-sapphire.png`} alt="Sapphire (Material)" />
                                    <span>Sapphire</span>
                                    <Badge value="Material" severity="info"></Badge>
                                </a>
                            </li>
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/serenity-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-serenity.png`} alt="Serenity (Material)" />
                                    <span>Serenity</span>
                                    <Badge value="Material" severity="info"></Badge>
                                </a>
                            </li>
                            <li role="none">
                                <a href="https://www.primefaces.org/layouts/avalon-react" role="menuitem" rel="noopener noreferrer" target="_blank">
                                    <img src={`${contextPath}/images/layouts/themeswitcher-avalon.png`} alt="Avalon (Bootstrap)" />
                                    <span>Avalon</span>
                ...
                <li role="none" className="topbar-submenu">
                    <button type="button" role="menuitem" onClick={(e) => toggleMenu(3)} aria-haspopup className="p-link">
