...
export class DocActions extends Component {
    ...
    viewOnGitHub() {
        window.open('https://github.com/primefaces/primereact/blob/master/pages/' + this.props.github, '_blank');
    }
    ...
    render() {
        return (
            <div className="app-demoactions flex align-items-end justify-content-end mt-3">
                ...
                <Button icon="pi pi-github" className="p-button-text p-button-rounded p-button-plain p-button-lg ml-2" onClick={this.viewOnGitHub} ></Button >
                <Button icon="pi pi-info-circle" className="p-button-text p-button-rounded p-button-plain p-button-lg ml-2" onClick={this.scrollToDocs} ></Button >
