...
`}
                    ...
                    <p>
                        Listbox is used as a controlled component with <i>value</i> and <i>onChange</i> properties along with the options collection. There are two alternatives of how to define the options property; One way is providing a collection
...
`}
                    ...
                    <p>
                        ...
                        individually depending on the value of <i>metaKeySelection</i> property value which is false by default. On touch enabled devices metaKeySelection is turned on automatically even when enabled.
                    </p>
...
`}
                    ...
                    <p>
                        Label of an option is used as the display text of an item by default, for custom content support define an <i>itemTemplate</i> property. Its value can be JSXElement, function or string. For custom filter support, define a{' '}
                        <i>filterTemplate</i> function that gets the option instance as a parameter and returns the content for the filter element.
                    </p>
...
`}
                    ...
                    <p>
                        ...
                        properties of the options. In addition <i>filterMatchMode</i> can be utilized to define the filtering algorithm, valid options are "contains" (default), "startsWith", "endsWith", "equals" and "notEquals". Also, the{' '}
                        <i>filterValue</i> and <i>onFilterValueChange</i> properties can be used to control the filter value.
                    </p>
...
`}
                    ...
                    <p>
                        Filter input can be customized with the <i>filterInputProps</i> option that passes any property to the filter input element.
                    </p>
                    <CodeHighlight>
                        {`
