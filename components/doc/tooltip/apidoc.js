...
export function ApiDoc(props) {
    return (
        <>
            ...
            <DocSubSection id="tooltipproperties" label="Tooltip Options">
            ...
            <DocSubSection id="globaltooltip" label="Global Tooltip">
                <p>
...
`}
            ...
            <DocSubSection id="customcontent" label="Custom Content">
...
`}
            ...
            <DocSubSection id="targetelement" label="Target Element Options">
                <div className="doc-tablewrapper">
                    <table className="doc-table">
                        <thead>
                            <tr>
            ...
            <DocSubSection id="tooltipcomponent" label="Tooltip Component Properties">
                <p>
