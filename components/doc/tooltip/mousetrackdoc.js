...
export default function MouseTrackDemo() {
    return (
        <div className="card flex flex-wrap align-items-center justify-content-center gap-5">
            ...
            <Tooltip target=".logo" mouseTrack mouseTrackLeft={10} />
            <img className="logo" alt="logo" src="images/logo.png" data-pr-tooltip="PrimeReact-Logo" height="80px" onError={(e) => (e.target.src = 'https://www.primefaces.org/cdn/images/placeholder.png')} />
        </div>
    );
}
        `,
