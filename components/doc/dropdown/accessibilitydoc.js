...
<Dropdown aria-label="Options" />
    ...
    return (
        <DocSectionText id="accessibility" label="Accessibility">
            ...
            <p>
                The popup list has an id that refers to the <i>aria-controls</i> attribute of the <i>combobox</i> element and uses <i>listbox</i> as the role. Each list item has an <i>option</i> role, an id to match the <i>aria-activedescendant</i>{' '}
                of the input element along with <i>aria-label</i>, <i>aria-selected</i> and <i>aria-disabled</i> attributes.
            </p>
