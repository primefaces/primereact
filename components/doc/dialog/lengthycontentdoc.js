...
export function LengthyContentDoc(props) {
    ...
    const code = {
        basic: `
<Button label="Lengthy Content" icon="pi pi-external-link" onClick={() => onClick('displayBasic')} className="mr-2" />
...
export default function LengthyContentDoc() {
    const [displayBasic, setDisplayBasic] = useState(false);
