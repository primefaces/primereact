                ...
                <div className="layout-config-content-wrapper">
                    ...
                    <div className="layout-config-content">
                        <div className="free-themes">
                            ...
                            <p>Built-in component themes created by the <a href="https://www.primefaces.org/designer/primereact" rel="noopener noreferrer" target="_blank">PrimeReact Theme Designer</a>.</p>
                            <div className="p-grid">
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-nova-light.png" alt="Nova Light" onClick={e => this.onThemeChange(e, 'nova-light', false)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-nova-dark.png" alt="Nova Dark" onClick={e => this.onThemeChange(e, 'nova-dark', false)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-nova-colored.png" alt="Nova Colored" onClick={e => this.onThemeChange(e, 'nova-colored', false)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-luna-amber.png" alt="Luna Amber" onClick={e => this.onThemeChange(e, 'luna-amber', true)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-luna-blue.png" alt="Luna Blue" onClick={e => this.onThemeChange(e, 'luna-blue', true)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-luna-green.png" alt="Luna Green" onClick={e => this.onThemeChange(e, 'luna-green', true)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-luna-pink.png" alt="Luna Pink" onClick={e => this.onThemeChange(e, 'luna-pink', true)} />
                                ...
                                <div className="p-col-3">
                                    <button type="button" className="p-link">
                                        <img src="showcase/images/layouts/themeswitcher-rhea.png" alt="Rhea" onClick={e => this.onThemeChange(e, 'rhea', false)} />
