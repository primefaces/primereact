            ...
            <div className="layout-topbar">
                <div className="layout-topbar-left">
                    ...
                    <Link to="/" className="logo" aria-label="PrimeReact logo">
                        <img alt="logo" src="showcase/images/primereact-logo.png" />
                    </Link>
                </div>
                        ...
                        <li role="none" className={classNames({ 'topbar-menuitem-active': this.props.activeTopbarItem === 'themes' })}
                            ...
                            <CSSTransition classNames="topbar-submenu" timeout={{ enter: 0, exit: 0 }} in={this.props.activeTopbarItem === 'themes'}>
                                <ul role="menu" aria-label="Themes" className="topbar-submenu">
                                    ...
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'nova-light', false)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-nova-light.png" alt="Nova Light" /><span>Nova Light</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'nova-dark', false)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-nova-dark.png" alt="Nova Dark" /><span>Nova Dark</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'nova-colored', false)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-nova-colored.png" alt="Nova Colored" /><span>Nova Colored</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'luna-amber', true)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-luna-amber.png" alt="Luna Amber" /><span>Luna Amber</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'luna-blue', true)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-luna-blue.png" alt="Luna Blue" /><span>Luna Blue</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'luna-green', true)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-luna-green.png" alt="Luna Green" /><span>Luna Green</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'luna-pink', true)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-luna-pink.png" alt="Luna Pink" /><span>Luna Pink</span></button></li>
                                    <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'rhea', false)} role="menuitem"><img src="showcase/images/layouts/themeswitcher-rhea.png" alt="Rhea" /><span>Rhea</span></button></li>
                                </ul>
                            </CSSTransition>
                        </li>
