...
describe('<Checkbox />', () => {
    ...
    it('should call OnClick() and change checked', () => {
        ...
        const wrapper = mount(<Checkbox onChange={(event) => { oldChecked = event.target.checked }} />);
    ...
    it('should change checked prop when clicked', () => {
        const onClickSpy = jest.spyOn(Checkbox.prototype, 'onClick');
        const onFocusSpy = jest.spyOn(Checkbox.prototype, 'onFocus');
