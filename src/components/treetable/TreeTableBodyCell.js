...
export class TreeTableBodyCell extends Component {
    ...
    render() {
        ...
        /* eslint-disable */
        const editorKeyHelper = this.props.editor && <a href="#" ref={(el) => {this.keyHelper = el;}} className="p-cell-editor-key-helper p-hidden-accessible" onFocus={this.onEditorFocus}><span></span></a>;
        /* eslint-enable */
