    ...
    renderElement() {
        ...
        if (body && !this.state.editing) {
            ...
            content = showSelection && (
                <>
                    {selectionMode === 'single' && <RowRadioButton value={this.props.rowData} disabled={isDisabled} checked={this.props.selected} onChange={this.props.onRadioChange} tabIndex={this.props.tabIndex} tableSelector={this.props.tableSelector} />}
                    {selectionMode === 'multiple' && <RowCheckbox value={this.props.rowData} disabled={isDisabled} checked={this.props.selected} onChange={this.props.onCheckboxChange} tabIndex={this.props.tabIndex} />}
                </>
            )
        }
        else if (rowReorder) {
