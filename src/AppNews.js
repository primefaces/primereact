            ...
            <React.Fragment>
                {
                    this.props.newsActive && <div className="layout-news" onClick={() => window.open('https://www.primefaces.org/store', '_blank')}>
                        <div className="layout-news-container">
                            <img src="showcase/resources/images/news/topbar-easter-2020-text.png" className="layout-news-text" alt="New Year" />
                            <img src="showcase/resources/images/news/topbar-easter-2020-ultima.png" className="layout-news-helper-image" alt="New Year" />
