            ...
            <div>
                ...
                <div className="content-section implementation">
                    <div className="card">
                        ...
                        <div className="p-fluid p-grid p-formgrid">
                            ...
                            <div className="p-field p-col-12 p-md-4">
                                ...
                                <Calendar
                                    ...
                                    onChange={(e) =>
                                        this.setState({ date11: e.value })
                                    }
                                    numberOfMonths={3}
                                />
                            </div>
                            <div className="p-field p-col-12 p-md-4">
                                <label htmlFor="datetemplate">
                                    Date Template
                                </label>
                                <Calendar
                                    id="datetemplate"
                        ...
                        <h5>Inline</h5>
                        <Calendar
                            value={this.state.date15}
                            onChange={(e) => this.setState({ date15: e.value })}
                            inline
                        />
                    </div>
                </div>
