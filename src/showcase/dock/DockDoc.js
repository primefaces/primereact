...
`}
                        ...
                        <h5>MenuModel API</h5>
                        <p>Dock uses the common MenuModel API to define the items, visit <Link to="/menumodel">MenuModel API</Link> for details.</p>
                    ...
                    {
                        useLiveEditorTabs({ name: 'DockDemo', sources: this.sources, extFiles: this.extFiles })
                    }
