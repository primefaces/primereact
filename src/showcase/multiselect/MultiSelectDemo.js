    ...
    renderSourceButtons() {
        return (
            <div className="source-button-group">
                ...
                <LiveEditor name="MultiSelectDemo" sources={this.sources} service="NodeService" data="treenodes" extFiles={this.extFiles} activeButtonIndex={this.state.activeIndex - 1} />
            </div>
        )
    }
