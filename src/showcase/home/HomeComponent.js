            ...
            <div className="home">
                ...
                <div className="whouses">
                    ...
                    <p>Open source products of <a href="http://www.primetek.com.tr">PrimeTek</a> are used all around the world by 1M+ developers in Fortune 500 companies, corporations, government and educational
                        institutions.</p>
                    <div className="p-g">
                        <div className="p-g-6 p-md-2"><img alt="airbus" src="showcase/resources/images/home/airbus.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="amex" src="showcase/resources/images/home/amex.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="bmw" src="showcase/resources/images/home/bmw.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="ebay" src="showcase/resources/images/home/ebay.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="ford" src="showcase/resources/images/home/ford.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="fox" src="showcase/resources/images/home/fox.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="lufthansa" src="showcase/resources/images/home/lufthansa.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="mercedes" src="showcase/resources/images/home/mercedes.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="sap" src="showcase/resources/images/home/sap.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="unicredit" src="showcase/resources/images/home/unicredit.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="verizon" src="showcase/resources/images/home/verizon.svg"/></div>
                        <div className="p-g-6 p-md-2"><img alt="viacom" src="showcase/resources/images/home/viacom.svg"/></div>
                    </div>
                </div>
