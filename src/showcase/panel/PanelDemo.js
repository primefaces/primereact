                ...
                <div className="content-section introduction">
                    <div className="feature-intro">
                        ...
                        <AppContentContext.Consumer>
                            { context => <button onClick={() => context.onChangelogBtnClick("panel")} className="layout-changelog-button">{context.changelogText}</button> }
                        </AppContentContext.Consumer>
                    </div>
                </div>
    ...
    renderSourceButtons() {
        return (
            <div className="source-button-group">
                ...
                <LiveEditor name="PanelDemo" sources={this.sources} activeButtonIndex={this.state.activeIndex - 1} />
            </div>
        )
    }
