        ...
        <div>
            ...
            <div className="content-section introduction">
                <div className="feature-intro">
                    ...
                    <p>
                        PrimeReact components can be easily used/integrated with <a href="https://final-form.org/react">React Final Form</a>. In this example, a register panel is simulated using React Final Form.
                    </p>
                </div>
...
@media screen and (max-width: 640px) {
    ...
    return (
        <div className="content-section documentation" id="app-doc">
            <TabView>{useLiveEditorTabs({ name: 'ReactFinalFormDemo', sources, service: 'CountryService', data: 'countries', extFiles, dependencies: { 'final-form': '^4.20.2', 'react-final-form': '^6.5.3' } })}</TabView>
        </div>
    );
});
