        ...
        <div>
            ...
            <div className="content-section introduction">
                <div className="feature-intro">
                    <h1>
                        TreeTable <span>Responsive</span>
                    </h1>
...
@media screen and (max-width: 40em) {
    ...
    return (
        <div className="content-section documentation" id="app-doc">
            <TabView>{useLiveEditorTabs({ name: 'TreeTableResponsiveDemo', sources: sources, service: 'NodeService', data: 'treetablenodes', extFiles: extFiles })}</TabView>
        </div>
    );
});
