            ...
            <div>
                ...
                <div className="content-section">
                    <div style={{ borderRadius: '50px', maxHeight: '500px' }} className="overflow-hidden mb-5 flex align-items-center">
                        <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/primeone-cover-${props.dark ? 'dark' : 'light'}.jpeg`} className="w-full" />
                    </div>
                    ...
                    <div className="card mb-5" style={{ borderRadius: '50px' }}>
                        <div className="flex flex-column md:flex-row align-items-center gap-4 md:gap-8 mb-8">
                            <div className="w-full md:w-6">
                                <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/uikit-figma.png`} className="w-full" />
                            </div>
                            <div className="w-full md:w-6">
                        ...
                        <div className="flex flex-column md:flex-row align-items-center gap-4 md:gap-8 mb-8">
                            ...
                            <div className="w-full md:w-6">
                                <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/uikit-system.png`} className="w-full" />
                            </div>
                        </div>
                        <div className="flex flex-column md:flex-row align-items-center gap-4 md:gap-8">
                            <div className="w-full md:w-6">
                                <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/uikit-themes.png`} className="w-full" />
                            </div>
                            <div className="w-full md:w-6">
                    ...
                    <div className="flex flex-column md:flex-row gap-4 md:gap-8 mb-5">
                        ...
                        >
                            ...
                            <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/logo-figma-light.svg`} className="w-4rem" />
                        </a>
                        <a
                        ...
                        >
                            ...
                            <img alt="PrimeReact Designer" src={`https://www.primereact.org/images/uikit/logo-figma-dark.svg`} className="w-4rem" />
                        </a>
                    </div>
                        ...
                        <div className="grid">
                            ...
                            <div className="col-12 lg:col-4 px-2 lg:px-5">
                                ...
                                <p className="mt-0 mb-6 p-0 line-height-3">
                                    ...
                                    <a href="mailto:contact@primetek.com.tr" className="text-primary-500 no-underline hover:underline">
                                        contact us
                                    </a>{' '}
                            ...
                            <div className="col-12 lg:col-4 px-2 lg:px-5">
                                ...
                                <p className="mt-0 mb-6 p-0 line-height-3">
                                    ...
                                    <a href="https://forum.primefaces.org/viewforum.php?f=159" className="text-primary-500 no-underline hover:underline">
