...
`}
                                    ...
                                    {shades.map((shade) => {
                                        return (
                                            <React.Fragment key={shade}>
                                                {shade !== 0 && (
                                                    <div className="color-box" style={{ backgroundColor: `var(--${color}-${shade})`, color: shade > 500 ? '#fff' : '#000' }}>
                                                        {color}-{shade}
                                                    </div>
                                                )}
                                            </React.Fragment>
                ...
                <div className="card">
                    <div className="color-stack">
                        {shades.map((shade) => {
                            return (
                                <div key={shade} className="color-box" style={{ backgroundColor: `var(--surface-${shade})`, color: props.dark ? '#fff' : shade > 500 ? '#fff' : '#000' }}>
                                    surface-{shade}
                                </div>
                            );
                        })}
