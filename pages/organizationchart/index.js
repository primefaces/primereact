...
export default class OrganizationChartDemo extends Component {
            ...
            return (
                <div>
                    ...
                    <div className="node-content">
                        <img alt={node.data.avatar} src={`${this.contextPath}/images/organization/${node.data.avatar}`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} style={{ width: '32px' }} />
