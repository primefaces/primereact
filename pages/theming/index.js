...
`}
                ...
                <p>
                    Designer themes apply a global skin to the library, in case you need to change the style of a particular component, you may use a named class, CSS Modules or a CSS-in-JS solution like styled-jsx. A video tutorial that goes through
                    the alternatives below is available.
                </p>
                ...
                <h6>Named Class</h6>
                <p>
                    A named class is bound to the className prop of a component and the CSS is included with an import. Note that, the css still is still bundled globally so prefer this approach if your application doesn't have a built-in solution to
                    do CSS scoping.
                </p>
                <i>custompanel.css</i>
...
`}
                ...
                <p>
                    Then use <i>mypanel</i> class as the className of your panel.
                </p>
                <CodeHighlight>
                    {`
import React from 'react';
...
`}
                ...
                <p>
                    ...
                    selectors can be used as a common workaround. NextJS has built-in support for CSS modules allowing css files with <i>.module.css</i> suffix to be interpreted as modules.
                </p>
...
`}
                ...
                <h5>Scaling</h5>
                <p>
                    PrimeReact utilizes rem units to make sure the components blend in with the rest of your UI perfectly. This also enables scaling, for example changing the size of the components is easy as configuring the font size of your
                    document. Code below sets the scale of the components based on 16px. If you reqire bigger or smaller components, just change this variable and components will scale accordingly.
                </p>
