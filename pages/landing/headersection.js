...
const HeaderSection = (props) => {
    ...
    return (
        <div ref={containerRef} className="layout-topbar">
            <div className="layout-topbar-inner">
                <div className="layout-topbar-logo-container">
                    <Link href="/" aria-label="PrimeVue logo">
                        <a className="layout-topbar-logo">
                            <svg width="165" height="40" viewBox="0 0 165 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M12.0297 0L17.1214 13.1536L22.5526 0H12.0297Z" fill="var(--primary-color)" />
                            </svg>
                        </a>
                    </Link>
                    <Link href="/" aria-label="PrimeVue logo">
                ...
                <ul className="flex list-none m-0 p-0 gap-2 align-items-center">
                    ...
                    <li>
                        <Link href="https://github.com/primefaces/primevue" target="_blank" rel="noopener noreferrer">
                            <a className="flex flex-shrink-0 px-link border-1 border-solid w-2rem h-2rem surface-border border-round surface-card align-items-center justify-content-center transition-all transition-duration-300 hover:border-primary">
                                <i className="pi pi-github text-700"></i>
                            </a>
                        </Link>
                    </li>
                    <li>
                        <Link href="https://discord.gg/gzKFYnpmCY" target="_blank" rel="noopener noreferrer">
                            <a className="flex flex-shrink-0 px-link border-1 border-solid w-2rem h-2rem surface-border border-round surface-card align-items-center justify-content-center transition-all transition-duration-300 hover:border-primary">
                    ...
                    <li>
                        <Link href="https://github.com/orgs/primefaces/discussions" target="_blank" rel="noopener noreferrer">
                            <a className="flex flex-shrink-0 px-link border-1 border-solid w-2rem h-2rem surface-border border-round surface-card align-items-center justify-content-center transition-all transition-duration-300 hover:border-primary">
                        ...
                        <div className="p-3 surface-overlay hidden absolute right-0 top-auto border-round shadow-2 origin-top w-8rem">
                            <ul className="list-none m-0 p-0">
                                {versions.forEach((version) => {
                                    <li key={version.version} role="none">
                                        <Link href={version.url} className="inline-flex p-2 border-round hover:surface-hover w-full">
