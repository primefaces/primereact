const FeaturesSection = (props) => {
    return (
        <section className="landing-features py-8">
            ...
            <div className="grid grid-nogutter mt-7 pad-section" style={{ backgroundImage: `url(https://www.primereact.org/images/landing-new/wave-${props.dark ? 'dark-alt' : 'light-alt'}.svg)`, backgroundSize: 'cover' }}>
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-components.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-community.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-productivity.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-accessibility.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-support.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-mobile.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-theme.svg`} alt="components icon" className="block mb-3" />
                ...
                <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                    <div className="box p-4 w-full">
                        <img src={`https://www.primereact.org/images/landing-new/features/icon-ts.svg`} alt="components icon" className="block mb-3" />
