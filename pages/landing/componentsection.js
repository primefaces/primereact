                    ...
                    <div className="box p-4">
                        <ul className="list-none p-0 m-0">
                            <li className="flex align-items-center mb-3">
                                <img src={'/images/landing-new/avatar-1.svg'} alt="avatar 1" className="w-2rem h-2rem mr-3" />
                            ...
                            <li className="flex align-items-center mb-3">
                                <img src={'/images/landing-new/avatar-2.svg'} alt="avatar 2" className="w-2rem h-2rem mr-3" />
                            ...
                            <li className="flex align-items-center mb-3">
                                <img src={'/images/landing-new/avatar-3.svg'} alt="avatar 3" className="w-2rem h-2rem mr-3" />
                            ...
                            <li className="flex align-items-center mb-3">
                                <img src={'/images/landing-new/avatar-4.svg'} alt="avatar 4" className="w-2rem h-2rem mr-3" />
                            ...
                            <li className="flex align-items-center mb-3">
                                <img src={'/images/landing-new/avatar-5.svg'} alt="avatar 5" className="w-2rem h-2rem mr-3" />
                ...
                <div className="flex flex-column justify-content-start px-3 z-1">
                    <div className="box p-4 mb-5">
                        <div className="surface-card mb-4 w-20rem text-center p-5" style={{ borderRadius: '10px' }}>
                            <img src={'/images/landing-new/watch.png'} alt="Watch" />
                        </div>
