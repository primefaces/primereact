...
export default function GetStartedSection() {
    return (
        <section className="landing-getstarted flex align-items-center justify-content-center py-8">
            <Link href="/setup">
                <a className="linkbox active font-medium py-3 px-4">Get Started <i className="pi pi-arrow-right ml-3"></i></a>
            </Link>
            <div className="box font-medium p-3 px-4 ml-3 bg-transparent inline-flex align-items-center">
