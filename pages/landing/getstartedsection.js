...
export default function GetStartedSection() {
    return (
        <section className="landing-getstarted flex align-items-center justify-content-center mt-8 z-1">
            ...
            <div className="box download-box font-medium p-3 px-4 ml-3 bg-transparent inline-flex align-items-center fadeinright animation-duration-2000 animation-ease-out">
