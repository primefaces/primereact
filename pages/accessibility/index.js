    ...
    return (
        <div>
            ...
            <div className="content-section documentation">
                ...
                WCAG consists of recommendations for making the web content more accessible. PrimeReact components aim high level of WCAG compliancy in the near future.</p>
...
`}
                ...
                <p>ARIA refers to "Accessible Rich Internet Applications" is a suite to fill the gap where semantic HTML is inadequate. These cases
                    ...
                    many web developers still utilize UI components derived from standard HTML elements created by them or by other projects like PrimeReact. These
...
`}
                ...
                <p>A working sample is the PrimeReact checkbox that is tabbable, keyboard accessible and is compliant with a screen reader. Instead of ARIA
                    roles it relies on a hidden native checkbox.
                </p>

                <div className="flex align-items-center">
                    <label htmlFor="binary" className="mr-2">Remember Me</label>
