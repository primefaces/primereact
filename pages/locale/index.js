    ...
    return (
        <div>
            ...
            <div className="content-section documentation">
                ...
                <p>
                    By using the <i>locale</i>, <i>addLocale</i>, <i>updateLocaleOption</i>, <i>updateLocaleOptions</i>, <i>localeOption</i> and <i>localeOptions</i> methods, locale objects can be used in the whole application or in certain pages.
                </p>
...
`}
                ...
                <p>
                    The current locale can be set with <i>locale</i> method.
                </p>
                <CodeHighlight lang="js">
                    {`
locale('en');
`}
                ...
                <p>
                    New locale values can be added using <i>addLocale</i> method for the application.
                </p>
                <CodeHighlight lang="js">
                    {`
addLocale('es', {
