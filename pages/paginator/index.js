...
export default class PaginatorDemo extends Component {
                ...
                <div className="content-section implementation paginator-demo">
                    <div className="card">
                        ...
                        <div className="image-gallery">
                            <img alt={this.state.contentFirst} src={`${this.contextPath}/images/nature/nature${this.state.contentFirst + 1}.jpg`} onError={(e) => e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} />
                        </div>
                    </div>
                </div>
