...
const MenuDemo = () => {
    ...
    return (
        <DocComponent title="React Menu Component" header="Menu" description="Menu is a navigation/command component that supports dynamic and static positioning." componentDocs={docs} apiDocs={[{ name: 'Menu', pathname: '/modules/menu.html' }]} />
    );
};
