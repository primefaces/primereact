...
export default class DataTableStateDemo extends Component {
    ...
    countryBodyTemplate(rowData) {
        return (
            <React.Fragment>
                <img alt={rowData.country.code} src={`${this.contextPath}/images/flag/flag_placeholder.png`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} className={`flag flag-${rowData.country.code}`} width="30" />
