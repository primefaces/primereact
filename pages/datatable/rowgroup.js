...
export default class DataTableRowGroupDemo extends Component {
    ...
    headerTemplate(data) {
        return (
            <React.Fragment>
                <img alt={data.representative.name} src={`${this.contextPath}/images/avatar/${data.representative.image}`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} width="32" style={{ verticalAlign: 'middle' }} />
    ...
    countryBodyTemplate(rowData) {
        return (
            <React.Fragment>
                <img alt={rowData.country.name} src={`${this.contextPath}/images/flag/flag_placeholder.png`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} className={`flag flag-${rowData.country.code}`} width="30" />
    ...
    representativeBodyTemplate(rowData) {
        return (
            <React.Fragment>
                <img alt={rowData.representative.name} src={`${this.contextPath}/images/avatar/${rowData.representative.image}`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} width="32" style={{ verticalAlign: 'middle' }} />
