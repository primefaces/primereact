...
const CaliforniaPage = () => {
    ...
    return (
        <div className="california template">
            ...
            imageURL="/images/templates/california/california-intro.png"
            />
            <CaliforniaSeparator />
