...
const CardDemo = () => {
    ...
    const header = <img alt="Card" src={`${contextPath}/images/usercard.png`} onError={(e) => (e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png')} />;
    const footer = (
        <span>
