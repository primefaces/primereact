 ...
 *
 * [Live Demo](https://www.primereact.org/iftalabel/)
 *
 * @module IftaLabel
 * @group components
 *
...
import type { useIftaLabelExposes, useIftaLabelProps, useIftaLabelState } from './useIftaLabel.types';
 ...
 */
export interface IftaLabelProps extends BaseComponentProps<IftaLabelInstance, useIftaLabelProps, IftaLabelPassThrough> {}

/**
 * Defines valid state in IftaLabel component.
 */
export interface IftaLabelState extends useIftaLabelState {}

/**
 * Defines the methods and properties exposed by IftaLabel component.
 */
export interface IftaLabelExposes extends useIftaLabelExposes {}
