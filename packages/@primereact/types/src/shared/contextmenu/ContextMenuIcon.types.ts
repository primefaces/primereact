...
import type { MenuIconPassThrough, MenuRootInstance } from '@primereact/types/shared/menu';
 ...
 * @extends MenuIconPassThrough
 */
export interface ContextMenuIconPassThrough extends MenuIconPassThrough {}
