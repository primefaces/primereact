...
.p-toast-region[data-position="bottom-right"] {
    right: 2rem;
    bottom: 2rem;
}

.p-toast-region[data-position="bottom-center"] {
    bottom: 2rem;
    left: 50%;
    transform: translateX(-50%);
}

.p-toast-region[data-position="bottom-left"] {
    left: 2rem;
    bottom: 2rem;
}

.p-toast-region[data-position="top-right"] {
    right: 2rem;
    top: 2rem;
}

.p-toast-region[data-position="top-center"] {
    left: 50%;
    transform: translateX(-50%);
    top: 2rem;
}

.p-toast-region[data-position="top-left"] {
    left: 2rem;
    top: 2rem;
}
...
.p-toast[data-mounted="true"] {
    opacity: 1;
    transform: translateY(0);
}

.p-toast[data-expanded="false"][data-front="false"] {
    overflow: hidden;
...
.p-toast[data-mounted="true"][data-expanded="true"] {
    height: var(--initial-height);
    transform: translateX(var(--offset-x)) translateY(var(--offset-y));
}

.p-toast[data-expanded="true"]::after {
    content: "";
    position: absolute;
    left: 0;
...
.p-toast[data-visible="false"] {
    opacity: 0;
    pointer-events: none;
    user-select: none;
}

.p-toast[data-removed="true"][data-front="true"][data-swipe-out="false"] {
    opacity: 0;
    transform: translateX(var(--offset-x)) translateY(calc(var(--raise-factor) * -100%));
}

.p-toast[data-removed="true"][data-front="false"][data-swipe-out="false"][data-expanded="true"] {
    opacity: 0;
    transform: translateX(var(--offset-x)) translateY(calc(var(--raise-factor) * var(--offset-y) * 0.4));
}

.p-toast[data-removed="true"][data-front="false"][data-swipe-out="false"][data-expanded="false"] {
    opacity: 0;
...
.p-toast[data-swiping="true"] {
    transition: none;
    transform: translateX(var(--offset-x)) translateY(var(--offset-y)) !important;
}

.p-toast[data-swiped="true"] {
    -webkit-user-select: none;
    user-select: none;
}

.p-toast[data-swipe-out="true"][data-swipe-direction="up"] {
    opacity: 0;
    transform: translateX(var(--offset-x)) translateY(calc(var(--offset-y) - 100%)) !important;
}

.p-toast[data-swipe-out="true"][data-swipe-direction="down"] {
    opacity: 0;
    transform: translateX(var(--offset-x)) translateY(calc(var(--offset-y) + 100%)) !important;
}

.p-toast[data-swipe-out="true"][data-swipe-direction="left"] {
    opacity: 0;
    transform: translateX(calc(var(--offset-x) - 100%)) translateY(var(--offset-y)) !important;
}

.p-toast[data-swipe-out="true"][data-swipe-direction="right"] {
    opacity: 0;
    transform: translateX(calc(var(--offset-x) + 100%)) translateY(var(--offset-y)) !important;
    transition:
        transform 500ms,
...
.p-toast[data-rich-colors="true"][data-variant="danger"] {
...
.p-toast[data-rich-colors="true"][data-variant="success"] {
...
.p-toast[data-rich-colors="true"][data-variant="info"] {
...
.p-toast[data-rich-colors="true"][data-variant="warn"] {
...
.p-toast-region[data-position="bottom-right"] .p-toast {
    --raise-factor: -1;
    bottom: 0;
    right: 0;
}

.p-toast-region[data-position="bottom-center"] .p-toast {
    --raise-factor: -1;
    bottom: 0;
}

.p-toast-region[data-position="bottom-left"] .p-toast {
    --raise-factor: -1;
    bottom: 0;
    left: 0;
}

.p-toast-region[data-position="top-right"] .p-toast {
    --raise-factor: 1;
    top: 0;
    right: 0;
}

.p-toast-region[data-position="top-center"] .p-toast {
    --raise-factor: 1;
    top: 0;
}

.p-toast-region[data-position="top-left"] .p-toast {
    --raise-factor: 1;
    top: 0;
    left: 0;
}
