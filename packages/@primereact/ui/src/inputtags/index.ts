...
export { defaultInputProps, defaultItemProps, defaultListProps, defaultOptionProps, defaultOptionsProps, defaultPortalProps, defaultRootProps, InputTagsPortal, InputTagsProps, InputTagsProvider, useInputTagsContext } from 'primereact/inputtags';
